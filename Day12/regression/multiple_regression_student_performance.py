...
x_train,x_test,y_train,y_test = train_test_split(x,y,test_size = 0.2,random_state = 0)#random_state = 0, for all results to be same just like
                                                                                            #seed() value   , if all random_states are same then result will be same for everyone for  the given number
